 ...
 */
final class Version20220425142509 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE utilisateur_v1 (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, login VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_naissance DATE NOT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE utilisateur_v1');
        $this->addSql('DROP INDEX IDX_A38D043C50EAE44');
        $this->addSql('DROP INDEX IDX_A38D043CF7384557');
        $this->addSql('DROP INDEX up_idx');
        $this->addSql('CREATE TEMPORARY TABLE __temp__im22_utilisateur_produit AS SELECT id, id_utilisateur, id_produit, quantite FROM im22_utilisateur_produit');
